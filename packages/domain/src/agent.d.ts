...
export type PluginType = 'AI Provider' | 'Context Provider' | 'Consensus Strategy' | 'Knowledge Extractor' | 'Exporter' | 'Reviewer' | 'Notification Provider' | 'GSD Phase Extension';
